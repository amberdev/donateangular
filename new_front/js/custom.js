       		...
       		if(successCallback.data.response.status=='Error')
       		{
				...
				if($scope.msg=successCallback.data.response.code='999')
				{
					...
					FB.login(function(response) 
					{
		 			...
		 			}, {scope: 'user_friends,read_stream,email,  read_friendlists, user_about_me, user_birthday, user_hometown, user_website,email, read_friendlists,publish_actions,publish_pages,manage_pages'});
